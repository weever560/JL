...
//lulu_code
static const u8 key_a_power_press[3] = {0x00,0x04,0x00};
static const u8 key_a_power_null[3] = {0x00,0x00,0x00};
...
#if TCFG_USER_EDR_ENABLE
    edr_hid_data_send(3,key_a_power_press,3);
    os_time_dly(2);
    edr_hid_data_send(3,key_a_power_null,3);
#else
    ble_hid_data_send(3,key_a_power_press,3);
    os_time_dly(2);
    ble_hid_data_send(3,key_a_power_null,3);
#endif
    led_on_off(LED_KEY_UP,0);
    break;
